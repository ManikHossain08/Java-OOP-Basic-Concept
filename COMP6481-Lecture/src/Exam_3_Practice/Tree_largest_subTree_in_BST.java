...
public class Tree_largest_subTree_in_BST { 

	private static subTreeNode root; 
	Value val = new Value(); 

	/* Returns size of the largest BST subtree in a Binary Tree 
	(efficient version). */
	int largestBST(subTreeNode node) { 
	...
	int largestBSTUtil(subTreeNode node, Value min_ref, Value max_ref, 
	...
	public static void main(String[] args) { 
		...
		*/
		...
		Tree_largest_subTree_in_BST tree = new Tree_largest_subTree_in_BST(); 
		tree.root = new subTreeNode(50); 
		tree.root.left = new subTreeNode(10); 
		tree.root.right = new subTreeNode(60); 
		tree.root.left.left = new subTreeNode(5); 
		tree.root.left.right = new subTreeNode(20); 
		tree.root.right.left = new subTreeNode(55); 
		tree.root.right.left.left = new subTreeNode(45); 
		tree.root.right.right = new subTreeNode(70); 
		tree.root.right.right.left = new subTreeNode(65); 
		tree.root.right.right.right = new subTreeNode(80); 
