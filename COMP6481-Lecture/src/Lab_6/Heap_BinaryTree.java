...
public class Heap_BinaryTree {
//https://www.geeksforgeeks.org/max-heap-in-java/?ref=rp
	//https://www.geeksforgeeks.org/min-heap-in-java/
	// https://medium.com/@rajagoyal815/day-7-a-newbies-guide-to-coding-a-priority-queue-with-binary-heap-100daysofcode-50614e90bfd
// https://www.edureka.co/blog/binary-heap-in-java/
	...
	// https://www.softwaretestinghelp.com/heap-data-structure-in-java/
	     ...
	     */
	    public Heap_BinaryTree(int capacity){
	        heapSize = 0;
	     ...
	     */
	     ...
	     public static void main(String[] args){
	    	 Heap_BinaryTree maxHeap = new Heap_BinaryTree(10);
	         maxHeap.insert(10);
	         maxHeap.insert(4);
	         maxHeap.insert(9);
	         maxHeap.insert(1);
